...
function TwitchIcon() { return <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden="true"><path fill="#9146FF" d="M4 3h17v12l-5 5h-4l-3 3H6v-3H2V7l2-4z" /><path fill="#FFFFFF" d="M6 5v12h4v3l3-3h4l2-2V5H6z" /><path fill="#9146FF" d="M9 8h2v6H9V8zm5 0h2v6h-2V8z" /></svg>; }
