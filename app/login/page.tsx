...
function XboxIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden="true">
      <path fill="#107C10" d="M256,0C114.62,0,0,114.62,0,256S114.62,512,256,512s256-114.62,256-256S397.38,0,256,0Zm120.3,382.84C355.51,438.39,308.27,466,256,466s-99.51-27.61-120.3-83.16C163.63,293.42,213.62,217.76,256,161.42,298.38,217.76,348.37,293.42,376.3,382.84ZM256,128c-18.44,0-33.15-8-47.5-24C236.4,85.39,269.17,64.21,304,54.49,286.72,67.6,272.54,92.51,256,128ZM95.27,159.2c22.68-12.87,54.43-32,89.31-56.12-12.37,12-24.06,24.78-34.84,38.16C121,180.22,100.29,246.52,95.75,287.9A231,231,0,0,1,95.27,159.2Zm225.42-56.12c34.88,24.13,66.63,43.25,89.31,56.12a231,231,0,0,1-.48,128.7c-4.54-41.38-25.26-107.68-54-146.66C344.75,127.86,333.06,115.08,320.69,103.08Z" />
    </svg>
  );
}
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-2">
           <Button variant="outline" onClick={() => oauth("discord")} disabled={busy} className="justify-center gap-2"><DiscordIcon />Continue with Discord</Button>
            ...
            <Button variant="outline" onClick={() => oauth("azure")} disabled={busy} className="justify-center gap-2"><XboxIcon />Continue with Xbox</Button>
