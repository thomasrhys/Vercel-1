...
function XboxIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden="true">
      <path fill="#107C10" d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0z" />
      <path fill="#000000" /* Adjust this to match your login card's background color (e.g., #000000 or #18181b) */ d="M12.2 4.4c-2.3 0-3.3 1.3-3.3 1.3L4.8 10.3c-.3.8-.5 1.7-.5 2.5 0 3.7 3.1 6.8 6.9 6.8 3.8 0 6.9-3.1 6.9-6.8 0-.9-.2-1.7-.5-2.5L15.5 5.7s-1-1.3-3.3-1.3zM12 5.8c1.8 0 2.5 1 2.5 1l3 3.8c.2.6.3 1.2.3 1.9 0 3.2-2.6 5.8-5.8 5.8S6.2 15.7 6.2 12.5c0-.7.1-1.3.3-1.9l3-3.8s.7-1 2.5-1z" />
    </svg>
  );
}
