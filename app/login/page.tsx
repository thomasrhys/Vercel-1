...
function XboxIcon() {
  return (
    <svg viewBox="0 0 512 512" className="h-5 w-5" aria-hidden="true">
      <g>
        <path fill="#107C10" d="M370.594,27.027c-35.744-17.93-74.3-27.025-114.596-27.025c-39.736,0-77.822,8.855-113.192,26.324
      ...
      <g>
        <path fill="#107C10" d="M416.609,56.643c-3.357-2.711-8.054-3.022-11.746-0.78c-24.893,15.098-63.394,39.801-105.422,71.739
