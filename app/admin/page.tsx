...
export default function AdminPage() {
  ...
  const handleToggleGameStatus = async (
    game: AdminGame,
    updates: { featured?: boolean; hidden?: boolean }
  ) => {
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Add a new game to Supabase without editing games.ts</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <Button onClick={handleAddGame} disabled={isAddingGame || !newGameTitle || !newGameUrl} className="w-full">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Select a game and upload a cover image to Vercel Blob</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <input id="cover-upload" type="file" accept="image/*" onChange={handleFileSelect} className="hidden" />
              </div>
            </div>
            {preview && (
              <div>
                <label className="block text-sm font-medium text-foreground mb-2">Preview</label>
                <img src={preview} alt="Preview" className="w-full max-w-xs h-auto rounded-md border border-border" />
              </div>
            )}
            <Button onClick={handleUpload} disabled={isUploading || !selectedFile || !selectedGameId} className="w-full">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Search your Supabase games, edit details, feature, hide, or delete entries.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
